...
namespace KIT206_RAP
{
    internal class FakeReasearcherData
    {
        public static List<Researcher> Generate()
        {
            ...
            {
                new Student(123456, "Jane", "Doe", Researcher.Title.Miss, Researcher.Campus.Hobart, Position.EmploymentLevel.Student, "Medicine", 11111),
               /* new Staff(Researcher.Title.Dr, "Marie", "Curie", Researcher.EmploymentLevel.B, 2),
                ...
                new Staff(Researcher.Title.Prof, "Stephen", "Hawkings", Researcher.EmploymentLevel.A, 5),
                new Student(Researcher.Title.Ms, "Amelia", "Reagan", Researcher.EmploymentLevel.Student, 6),
